# Neuro-Impact-Web
## Introduction
This project is the web version of Nokia 3310's classic game "Neuro Impact". A 2D shooter game, in which the player flies a spaceship and destroys incoming swarms of enemies spanning across 8 levels. Each level at the end has its own level boss. 

### [Live Demo](https://sidsinr.github.io/Neuro-Impact-Web)
...
## Disclaimer
Neuro Impact is a trademark of Nokia Inc. All rights reserved with Nokia Inc. This personal project is only for the educational purpose of learning Javascript and HTML Canvas; and it is no way intended for any commercial use or distribution.
